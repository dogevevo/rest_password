                                ...
                                <div class="col-lg-4 sidebar-widget">
                                    <div class="sidebar-info-widget">
                                        <a href="index.php" class="brand-logo"
                                            style="position: fixed;width: 311px; margin-top: -100px; margin-left: -60px;"><img
                                                src="img/logo/logo.png" alt="Site Logo"></a>
                                        <p></p>
                        ...
                        <div class="nav-menu">
                            ...
                            <nav class="main-menu">
                                <ul>
                                    ...
                                    <li class="menu-item has-children"><a href="review.php">Reviews</a></li>
